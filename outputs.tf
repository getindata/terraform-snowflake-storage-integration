output "name" {
  ...
  value       = one(snowflake_storage_integration.this[*].name)
}

output "comment" {
  description = "Specifies comment for the storage integration"
  value       = one(snowflake_storage_integration.this[*].comment)
}

output "type" {
  description = "Type of the storage integration"
  value       = one(snowflake_storage_integration.this[*].type)
}

output "storage_provider" {
  description = "Storage provider name"
  value       = one(snowflake_storage_integration.this[*].storage_provider)
}
...
output "storage_allowed_locations" {
  ...
  value       = one(snowflake_storage_integration.this[*].storage_allowed_locations)
}
...
output "storage_blocked_locations" {
  ...
  value       = one(snowflake_storage_integration.this[*].storage_blocked_locations)
}
...
output "azure_consent_url" {
  ...
  value       = one(snowflake_storage_integration.this[*].azure_consent_url)
}
...
output "azure_multi_tenant_app_name" {
  ...
  value       = one(snowflake_storage_integration.this[*].azure_multi_tenant_app_name)
}

output "azure_tenant_id" {
  description = "ID of the tenant"
  value       = one(snowflake_storage_integration.this[*].azure_tenant_id)
}

output "storage_aws_external_id" {
  description = "The external ID that Snowflake will use when assuming the AWS role"
  value       = one(snowflake_storage_integration.this[*].storage_aws_external_id)
}

output "storage_aws_iam_user_arn" {
  description = "The Snowflake user that will attempt to assume the AWS role"
  value       = one(snowflake_storage_integration.this[*].storage_aws_iam_user_arn)
}

output "storage_aws_object_acl" {
  description = "Name of the AWS access control lists (ACLs)"
  value       = one(snowflake_storage_integration.this[*].storage_aws_object_acl)
}

output "storage_aws_role_arn" {
  description = "AWS Role ARN"
  value       = one(snowflake_storage_integration.this[*].storage_aws_role_arn)
}
...
output "storage_gcp_service_account" {
  ...
  value       = one(snowflake_storage_integration.this[*].storage_gcp_service_account)
}
